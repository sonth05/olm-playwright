 ...
 *
 * Regression tests cho trang OLM Kids (/kids) — khối Mẫu giáo.
 *
 * Coverage:
 *  - Header        : logo, user menu (avatar trigger, popup, tên, các link)
 *  - Student box   : tên, trường, điểm thưởng, dải huy hiệu
 *  - Khóa học OLM  : danh sách course-card, title/url hợp lệ, click điều hướng
 *  - Vì sao chọn OLM Kids : 3 lý do
...
test.describe('Kids /kids @kids @regression', () => {
