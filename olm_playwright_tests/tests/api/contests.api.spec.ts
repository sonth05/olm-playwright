...
/**
 * Map từ postman/collections/OLM-vn/Contests - Cuoc Thi & ContestX/
 * - Get Cuoc Thi Home  GET /cuoc-thi      (= CUOC_THI_URL, đã có sẵn trong config.ts)
 * - Get ContestX       GET /contestx      (= CONTEST_URL, đã có sẵn trong config.ts)
 * - Get Contest Detail GET /bai-viet/:contestSlug
 */
