...
test.describe('Quản lý học liệu - Kiểm tra tính năng (Function) [OLM]', () => {
...
test.describe('NHCH - Kiểm tra tính năng (Function) [OLM]', () => {
...
test.describe('THEORY - Kiểm tra tính năng (Function) [OLM]', () => {
...
test.describe('VIDEO - Kiểm tra tính năng (Function) [OLM]', () => {
...
test.describe('ESSAY - Kiểm tra tính năng (Function) [OLM]', () => {
...
test.describe('LINK - Kiểm tra tính năng (Function) [OLM]', () => {
...
test.describe('PDF - Kiểm tra tính năng (Function) [OLM]', () => {
